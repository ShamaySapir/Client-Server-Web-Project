...
export default {
  ...
  mounted(){
    this.preview = salmonTacos.preview;
    this.instructions = salmonTacos.instructions;
    this.ingredients = salmonTacos.ingredients;
    this.servings = salmonTacos.servings;
  },
  components: {
    Recipe
  },
