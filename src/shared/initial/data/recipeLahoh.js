const lahoh = {
  ...
  ingredients: [
    ...
    {
      name: "margarine for wiping the pan",
      value: 1,
      units: "Tbsp",
    },
  ],
  instructions: [
    ...
    "Repeat the process, from the point where the pan is cooled under running water or in a bucket. There should be enough batter for a total of 6 lahoh.",
